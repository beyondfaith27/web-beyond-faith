...
const therapyExp = (
  <>
    <div className="space-y-8">
      <p>
        Your mental well-being matters. Our qualified therapists offer
        personalized sessions to help you navigate life’s challenges, emotional
        struggles, and mental health concerns with care and empathy.
      </p>

      <div className="space-y-4">
        <h4 className="text-lg font-semibold">Personalized Support</h4>
        <p>
          Whether you’re managing anxiety, stress, depression, or seeking
          personal growth, our therapists provide compassionate guidance
      ...
      <div className="space-y-4">
        <h4 className="text-lg font-semibold">Our Approach</h4>
        <ul className="list-disc pl-5 space-y-2">
          <li>Tailored therapy plans designed around your needs</li>
          <li>Evidence-based techniques including CBT, DBT, and EFT</li>
          <li>A safe, confidential, and non-judgmental space</li>
        </ul>
      </div>

      <p className="font-medium">Start your journey to healing today.</p>
    </div>
  </>
);

const teamTherapyExp = (
  <>
    <div className="space-y-8">
      <p>
        A mentally healthy team is a productive team. Our customized mental
        well-being programs help organizations build stronger, more resilient
        teams while addressing workplace stress, burnout, and emotional health.
      </p>

      <div className="space-y-4">
        <h4 className="text-lg font-semibold">Who We Work With</h4>
        <p>
          We partner with startups, corporates, and educational institutions to
          create supportive environments that promote collaboration, balance,
      ...
      <div className="space-y-4">
        <h4 className="text-lg font-semibold">Our Approach</h4>
        <ul className="list-disc pl-5 space-y-2">
          <li>Interactive workshops tailored to your team’s needs</li>
          <li>Group therapy sessions for collective well-being</li>
          <li>
            Strategies to improve communication, collaboration, and resilience
          </li>
        </ul>
      </div>

      <p className="font-medium">Invest in your team’s well-being today.</p>
    </div>
  </>
);
...
const SERVICES = [
  {
    ...
    description:
      "Personalized therapy to support your mental well-being and personal growth.",
    imageAlt: "therapy-image",
    explanation: therapyExp,
  },
  {
    imageSrc: "/images/team-therapy.svg",
    title: "Team Therapy",
    description:
      "Customized mental well-being programs that build resilient, healthy, and productive teams.",
    imageAlt: "therapy-image",
    explanation: teamTherapyExp,
  },
  {
