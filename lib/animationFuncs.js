...
const animFns = {
   ...
   */
  async homeHeroSection({ scope, animate }) {
    await animate("h1", anim.blurOut, anim.dur0);
    await animate("p", anim.blurOut, { duration: 0 });
    await animate("button", anim.blurOut, anim.dur0);
    await Promise.all([
      animate("h1", anim.blurIn, { duration: 0.3 }),
      animate("p", anim.blurIn, { duration: 0.3, delay: 0.1 }),
      animate("button", anim.blurIn, { duration: 0.3, delay: 0.2 }),
    ]);
  },
  ...
  async homeConcernSection({ animate }) {
    await Promise.all([
      animate("h3", anim.blurOut, anim.dur0),
      animate("p", anim.blurOut, anim.dur0),
      animate(".concern", { opacity: 0 }, anim.dur0),
    ]);
    await animate("h3", anim.blurIn, { duration: 0.3 });
    await animate("p", anim.blurIn, { duration: 0.3 });
    await animate(
      ".concern",
      { opacity: 1 },
      {
